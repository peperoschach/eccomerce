...
use Peperoschach\Mailer;

class User extends Model {

    const SESSION = "User";

    //for security, please change the key
    const SECRET = "another_brick_in_the_wall";
    ...
    public static function login($login, $password)
    {
        ...
        if (count($results) === 0)
        {
            throw new \Exception("Usuário inexistent ou senha inválida", 1);
        }
    ...
    public static function getForgot($email)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                // Change the link to your domain
                $link = "http://localhost/ecommerce/admin/forgot/reset?code=$resultCode";
    ...
    public static function validForgotDecrypt($code)
    {
        ...
        $codeResult = mb_substr($code, openssl_cipher_iv_length('aes-256-cbc'), null, '8bit');
        $iv = mb_substr($code, 0, openssl_cipher_iv_length('aes-256-cbc'), '8bit');;
        $idrecovery = openssl_decrypt($codeResult, 'aes-256-cbc', User::SECRET, 0, $iv);
        $sql = new Sql();
