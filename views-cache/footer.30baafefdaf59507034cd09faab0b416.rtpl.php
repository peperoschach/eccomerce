...
<div class="footer-bottom-area">
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <div class="copyright">
          <p>&copy; 2019 PEPE WebDeveloper. <a href="https://www.pepedev.com.br" target="_blank">pepedev.com.br</a></p>
        </div>
      </div>
...
<!-- jQuery sticky menu -->
<script src="/ecommerce/resources/site/js/owl.carousel.min.js"></script>
<script src="/ecommerce/resources/site/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/ecommerce/resources/site/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/ecommerce/resources/site/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/ecommerce/resources/site/js/bxslider.min.js"></script>
<script type="text/javascript" src="/ecommerce/resources/site/js/script.slider.js"></script>
</body>
